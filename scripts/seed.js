...
// NOTE: Katrina, Jilly, and Nick don't have product inventory yet —
// add their entries here (same shape as below) once their listings are ready.
const products = [
...
async function main() {
  ...
  try {
    ...
    // Insert Products (+ matching primary product_images row)
