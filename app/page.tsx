        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/shop" className="px-6 sm:px-8 py-3 sm:py-4 bg-[#C4622D] text-white rounded-full text-base sm:text-lg font-medium hover:bg-[#3D2B1F] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
                Shop Now
              </Link>
              <Link href="/sellers" className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-[#C4622D] text-[#C4622D] rounded-full text-base sm:text-lg font-medium hover:bg-[#C4622D] hover:text-white transition-all duration-300">
                Become a Seller
              </Link>
            </div>
          </div>
