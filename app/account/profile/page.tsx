      ...
      <section className="px-6 md:px-12 py-16 bg-[#F5F0E8]">
        <div className="max-w-xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold text-[#3D2B1F] mb-4">My Profile</h1>
            <div className="w-24 h-1 bg-[#7C9E87] mx-auto rounded-full"></div>
          </div>

          {loading ? (
            <p className="text-center text-[#3D2B1F] opacity-75">Loading your profile...</p>
          ) : (
            <form onSubmit={handleSubmit} className="bg-[#FDFAF6] rounded-2xl p-6 md:p-8 shadow-md space-y-6">
              ...
              <div>
                <label htmlFor="profileImageUrl" className="block text-sm font-medium text-[#3D2B1F] mb-2">
                  Profile Photo URL
                </label>
                <input
                  id="profileImageUrl"
                ...
                <p className="text-xs text-[#3D2B1F] opacity-50 mt-1">
                  Paste a link to an image for now — direct photo upload isn&apos;t built yet.
                </p>
              </div>
              ...
              {saved && <p className="text-[#7C9E87] font-medium text-sm">Profile updated successfully!</p>}
