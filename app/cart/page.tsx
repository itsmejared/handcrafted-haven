    ...
    <main>
      <section className="px-6 md:px-12 py-16 bg-[#F5F0E8] min-h-[60vh]">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-[#3D2B1F] mb-8 text-center">
            Your Cart
          </h1>
          ...
          {items.length === 0 ? (
            ...
            <>
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#C4622D] font-bold">
              ...
              <button className="w-full mt-6 py-4 bg-[#C4622D] text-white rounded-full text-lg font-medium hover:bg-[#3D2B1F] transition-all duration-300 shadow-lg">
